...
namespace DB.Basic
{
	...
	public class SQLiteHelper
	{
		...
		public static string ConnectionString
		{
			get
			{
				return "Data Source=" + (string.IsNullOrEmpty(Call_ParamUtil.m_sFreeSWITCHPath) ? @"C:\Program Files\FreeSWITCH" : Call_ParamUtil.m_sFreeSWITCHPath) + @"\\db\\sofia_reg_internal.db" + ";Pooling=true;FailIfMissing=false";
			}
		}
