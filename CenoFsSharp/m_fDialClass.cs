            ...
            try
            {
                ...
                if (m_bStar)
                {
                    ...
                    if (true)
                    {
                        ...
                        string m_sDtmfCmdMsgMusic = string.Empty;
                        string[] m_lDfmfCmd = m_sRealCalleeNumberStr.Trim('*').Split(new string[] { "*" }, StringSplitOptions.RemoveEmptyEntries);
                            ...
                            case "70":///取消
                                {
                                    if (m_fDialLimit.m_fSetUa2(m_uAgentID, "isinlimit_2", 0))
                                    {
                                        ...
                                        m_sDtmfCmdMsg = "2取消OK";
                                        m_sDtmfCmdMsgMusic = CenoCommon.m_mPlay._2closeok;
                                    }
                                    else
                                    {
                                        m_sDtmfCmdMsg = "2取消Err";
                                        m_sDtmfCmdMsgMusic = CenoCommon.m_mPlay._2closeerr;
                                    }
                                }
                                break;
                            case "71":///开启
                                {
                                    if (m_lDfmfCmd.Length > 1)
                                    {
                                            ...
                                            )
                                        {
                                            ...
                                            m_sDtmfCmdMsg = "2开启OK";
                                            m_sDtmfCmdMsgMusic = CenoCommon.m_mPlay._2openok;
                                        }
                                        else
                                        {
                                            m_sDtmfCmdMsg = "2开启Err";
                                            m_sDtmfCmdMsgMusic = CenoCommon.m_mPlay._2openerr;
                                        }
                                    }
                                    else
                                    {
                            ...
                            case "77":///设定星期
                                {
                                    if (m_lDfmfCmd.Length > 1)
                                    {
                                        ...
                                        if (m_fDialLimit.m_fSetUa2(m_uAgentID, "inlimit_2whatday", m_u77))
                                        {
                                            ...
                                            m_sDtmfCmdMsg = "2星期OK";
                                            m_sDtmfCmdMsgMusic = CenoCommon.m_mPlay._2whatdayok;
                                        }
                                        else
                                        {
                                            m_sDtmfCmdMsg = "2星期Err";
                                            m_sDtmfCmdMsgMusic = CenoCommon.m_mPlay._2whatdayerr;
                                        }
                                    }
                                    else
                                    {
                                        ...
                                        if (m_sSE.Length == 8)
                                        {
                                            ...
                                            if (m_uSH >= 0 && m_uSH <= 23 && m_uEH >= 0 && m_uEH <= 23 && m_uSM >= 0 && m_uSM <= 59 && m_uEM >= 0 && m_uEM <= 59)
                                            {
                                                    ...
                                                    )
                                                {
                                                    ...
                                                    m_sDtmfCmdMsg = "2时间OK";
                                                    m_sDtmfCmdMsgMusic = CenoCommon.m_mPlay._2timeok;
                                                }
                                                else
                                                {
                                                    m_sDtmfCmdMsg = "2时间Err";
                                                    m_sDtmfCmdMsgMusic = CenoCommon.m_mPlay._2timeerr;
                                                }
                                            }
                                            else
                                            {
                        ...
                        {
                            Log.Instance.Warn($"[CenoFsSharp][m_fDialClass][m_fDial][{m_uAgentID} set inlimit_2:{m_sDtmfCmdMsg}]");

                            #region ***提示音问题
                            int m_uPlayLoops = 1;
                            string m_sAnswer2 = "uuid_answer";
                            if (m_uPlayLoops > 0)
                            {
                                //应答播放声音
                                if (m_bIsDispose) return;
                                await m_pOutboundSocket.SendApi($"{m_sAnswer2} {uuid}").ContinueWith(task =>
                                {
                                    try
                                    {
                                        if (m_bIsDispose) return;
                                        if (task.IsCanceled) Log.Instance.Fail($"[CenoFsSharp][m_fCallClass][m_fCall][{uuid} {m_sAnswer2} cancel]");
                                    }
                                    catch (Exception ex)
                                    {
                                        Log.Instance.Error($"[CenoFsSharp][m_fCallClass][m_fCall][{uuid} {m_sAnswer2} error:{ex.Message}]");
                                    }
                                });
                                ...
                                {
                                    if (m_bIsDispose) return;
                                    await m_pOutboundSocket.Play(uuid, m_sDtmfCmdMsgMusic).ContinueWith(task =>
                                    {
                                        try
                                        {
                                            if (m_bIsDispose) return;
                                            if (task.IsCanceled) Log.Instance.Fail($"[CenoFsSharp][m_fCallClass][m_fCall][{uuid} Play 2 error music cancel]");
                                        }
                                        catch (Exception ex)
                                        {
                                            Log.Instance.Error($"[CenoFsSharp][m_fCallClass][m_fCall][{uuid} Play 2 error music error:{ex.Message}]");
                                        }
                                    });
                                }
                            }
                ...
                string m_sCallerStarPrefix = m_bStar ? $"*{m_mRecord.LocalNum.TrimStart('*')}" : m_mRecord.LocalNum;
